...
public class DeleteAccountUserActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_account_user);

        progressDialog = new ProgressDialog(DeleteAccountUserActivity.this);

        sharedPreferences = getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);

        currentPassword = (EditText) findViewById(R.id.deleteAccountUser_currentPassword);
        confirmPassword = (EditText) findViewById(R.id.deleteAccountUser_confirmPassword);
        deleteButton = (Button) findViewById(R.id.deleteAccountUser_deleteButton);

        mDialogMsg = new Dialog(DeleteAccountUserActivity.this);
    ...
    private void deleteAccount(final String UserPhone)
    {
                ...
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        if (response.contains("Connection failed!"))
                        {
                            ...
                            Toast.makeText(DeleteAccountUserActivity.this, response, Toast.LENGTH_SHORT).show();
                        }
                ...
                }, new Response.ErrorListener()
        {
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                {
                    progressDialog.dismiss();
                    Toast.makeText(DeleteAccountUserActivity.this, "Timeout error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof NoConnectionError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(DeleteAccountUserActivity.this, "No connection error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof AuthFailureError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(DeleteAccountUserActivity.this, "Authentication failure error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof NetworkError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(DeleteAccountUserActivity.this, "Network error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof ServerError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(DeleteAccountUserActivity.this, "Server error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof ParseError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(DeleteAccountUserActivity.this, "JSON parse error!", Toast.LENGTH_SHORT).show();
                }
            }
        })
        {
        ...
        MySingleton.getInstance(DeleteAccountUserActivity.this).addToRequestQueue(stringRequest);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            Intent profileIntent = new Intent(DeleteAccountUserActivity.this, ProfileActivity.class);
            startActivity(profileIntent);

        } else if (id == R.id.nav_editProfile) {

            Intent editProfileIntent = new Intent(DeleteAccountUserActivity.this, EditProfileUserActivity.class);
            startActivity(editProfileIntent);

        } else if (id == R.id.nav_changePassword) {

            Intent changePasswordIntent = new Intent(DeleteAccountUserActivity.this, ChangePasswordActivity.class);
    ...
    {
        Intent startPageIntent = new Intent(DeleteAccountUserActivity.this, StartPageActivity.class);
