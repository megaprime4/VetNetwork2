...
public class MyAdapterForRecycleView2 extends RecyclerView.Adapter<MyAdapterForRecycleView2.MyAdapterForRecycleView2ViewHolder>
{
    ...
    public MyAdapterForRecycleView2(List<ListItemForRecycleView1> listItems, Context context)
    {
    ...
    {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.all_users_display_layout_2, parent, false);
