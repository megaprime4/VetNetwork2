...
public class EditProfileUserActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
                            ...
                            final String postingArea, final String district, final String division)
    {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                Intent profileIntent = new Intent(EditProfileUserActivity.this, ProfileActivity.class);
                ...
                }, new Response.ErrorListener()
        {
            ...
            public void onErrorResponse(VolleyError error)
            {
                ...
                {
                    progressDialog.dismiss();
                    Toast.makeText(EditProfileUserActivity.this, "Timeout error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof NoConnectionError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(EditProfileUserActivity.this, "No connection error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof AuthFailureError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(EditProfileUserActivity.this, "Authentication failure error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof NetworkError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(EditProfileUserActivity.this, "Network error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof ServerError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(EditProfileUserActivity.this, "Server error!", Toast.LENGTH_SHORT).show();
                }
                else if (error instanceof ParseError)
                {
                    progressDialog.dismiss();
                    Toast.makeText(EditProfileUserActivity.this, "JSON parse error!", Toast.LENGTH_SHORT).show();
                }
            }
        })
        {
        ...
        MySingleton.getInstance(EditProfileUserActivity.this).addToRequestQueue(stringRequest);
    ...
    {
        Intent startPageIntent = new Intent(EditProfileUserActivity.this, StartPageActivity.class);
